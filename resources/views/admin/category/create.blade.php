                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <label>Name</label>
                                  <input name="name:de" placeholder="Tên danh mục" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Content</label>
                                  <textarea name="content:de" class="form-control" id="ckeditor2"></textarea>
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Title</label>
                                  <input name="title:de" placeholder="Tên danh mục" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Description</label>
                                  <input name="description:de" placeholder="Tên danh mục" type="text" class="form-control">
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <div id="load_category">
                            ...
                            <input type="hidden" value="0" name="category:de">
                          </div>
                      </div>
                  </div>
                  <div class="col-md-12">
